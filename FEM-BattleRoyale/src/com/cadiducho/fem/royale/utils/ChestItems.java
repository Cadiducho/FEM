...
public class ChestItems {
    ...
    private static void addMuyProbables() {
        ...
        muyProbables.add(new ItemBuilder().setType(Material.STONE_SWORD).build());
        ...
        muyProbables.add(new ItemBuilder().setType(Material.CHAINMAIL_HELMET).build());
        muyProbables.add(new ItemBuilder().setType(Material.LEATHER_HELMET).build());
        muyProbables.add(new ItemBuilder().setType(Material.CHAINMAIL_BOOTS).build());
