...
public class LuckyGladiators extends JavaPlugin {

    @Getter private static LuckyGladiators instance;
    ...
    public void onEnable() {
        ...
        getServer().getLogger().log(Level.INFO, "LuckyGladiators: Juego activado");
        world.setAutoSave(false);
    }

    @Override
    public void onDisable() {
        getServer().getLogger().log(Level.INFO, "LuckyGladiators: Juego desactivado");
    }    
}
